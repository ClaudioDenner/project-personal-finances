    ...
    return(
        <div className="balance_container">
            ...
            <div className='overall_balance'>
                ...
                <div class="progress-bar bg-primary" role="progressbar" aria-label="Info example" style={{width:`${percentIncome}%`}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div className='overall_balance'>
                ...
                <div class="progress" style={{height: "4px"}}>
                <div class="progress-bar bg-danger" role="progressbar" aria-label="Info example" style={{width:`${percentExpense}%`}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>

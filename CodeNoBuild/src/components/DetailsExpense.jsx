    ...
    return(
            ...
            
        {
            ...
            <div key={index} className='expense_details_item'>
                ...
                <div class="progress" style={{height: '4px', maxWidth:'100%', minWidth: '200px'}}>
                        <div class="progress-bar bg-danger" role="progressbar" aria-label="Basic example"   aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style={{width: e.percent}} ></div>
                    </div>
            </div>
            )
        }
